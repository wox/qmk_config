...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[6] = LAYOUT_split_3x5_2(QK_BOOT, KC_NO, HYPR(KC_F9), KC_NO, TO(10), KC_NO, LGUI(KC_PPLS), LGUI(KC_PMNS), KC_NO, KC_NO, KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, TO(11), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_MSTP, KC_MFFD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
