...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_TAB, KC_DEL, KC_LCTL, KC_LALT, SGUI(KC_Z), KC_PGUP, KC_HOME, KC_UP, KC_END, KC_NO, KC_ESC, KC_BSPC, KC_LGUI, LSFT_T(KC_ENT), LGUI(KC_Z), KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_ENT, LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[2] = LAYOUT_split_3x5_2(KC_F10, KC_F7, KC_F8, KC_F9, KC_NO, HYPR(KC_P), HYPR(KC_1), HYPR(KC_UP), HYPR(KC_2), HYPR(KC_M), KC_F11, KC_F4, KC_F5, KC_F6, KC_NO, LCA(KC_E), HYPR(KC_LEFT), HYPR(KC_DOWN), HYPR(KC_RGHT), LCA(KC_T), KC_F12, KC_F1, KC_F2, KC_F3, RESET, LCA(KC_D), HYPR(KC_3), HYPR(KC_ENT), HYPR(KC_4), LCA(KC_G), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[5] = LAYOUT_split_3x5_2(KC_NO, A(S(KC_F2)), LALT(KC_F2), C(S(KC_N)), KC_NO, HYPR(KC_F8), HYPR(KC_F4), HYPR(KC_F12), HYPR(KC_F13), HYPR(KC_F14), KC_NO, LGUI(KC_LBRC), LGUI(KC_RBRC), LGUI(KC_B), LGUI(KC_N), HYPR(KC_F), HYPR(KC_I), HYPR(KC_F5), HYPR(KC_F6), HYPR(KC_F15), KC_NO, LGUI(KC_1), LGUI(KC_F12), A(G(KC_B)), HYPR(KC_B), HYPR(KC_F7), HYPR(KC_F10), HYPR(KC_F11), KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[3] = LAYOUT_split_3x5_2(KC_NO, KC_TILD, KC_PIPE, KC_AMPR, KC_NO, KC_NO, KC_GRV, KC_DQUO, KC_QUOT, KC_NO, KC_DLR, KC_LBRC, KC_LCBR, KC_LPRN, KC_BSLS, KC_NO, KC_COLN, KC_SCLN, KC_EQL, KC_HASH, KC_NO, KC_RBRC, KC_RCBR, KC_RPRN, KC_NO, KC_NO, KC_EXLM, KC_QUES, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[6] = LAYOUT_split_3x5_2(RESET, KC_NO, HYPR(KC_F9), KC_NO, TO(10), KC_NO, LGUI(KC_EQL), LGUI(KC_MINS), KC_NO, KC_NO, KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_MPLY, KC_MFFD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[10] = LAYOUT_split_3x5_2(KC_Q, KC_W, KC_E, KC_R, KC_T, TO(0), KC_P7, KC_P8, KC_P9, KC_NO, KC_A, KC_S, KC_D, KC_F, KC_G, KC_NO, KC_P4, KC_P5, KC_P6, KC_P0, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_P1, KC_P2, KC_P3, KC_NO, KC_SPC, KC_LSFT, KC_NO, KC_NO)
};
...
// const uint16_t PROGMEM cmb_0[] = {KC_4, KC_5, COMBO_END};
