...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(KC_Q, KC_W, LCTL_T(KC_E), LALT_T(KC_R), KC_T, KC_Y, RALT_T(KC_U), RCTL_T(KC_I), KC_O, KC_P, KC_A, KC_S, LGUI_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RGUI_T(KC_K), KC_L, LSFT_T(KC_ESC), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, RALT(KC_W), RALT(KC_A), RALT(KC_O), LT(2,KC_SPC), LT(1,KC_TAB), LT(4,KC_ENT), LT(3,KC_BSPC)),
	[1] = LAYOUT_split_3x5_2(KC_NO, KC_TAB, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_PGDN, KC_UP, KC_PGUP, KC_NO, KC_ESC, KC_SPC, LGUI_T(KC_BSPC), LSFT_T(KC_ENT), KC_DEL, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_CAPS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), G(S(KC_Z)), KC_NO, KC_HOME, KC_NO, KC_END, KC_NO, KC_NO, KC_NO, KC_ENT, KC_BSPC),
	[2] = LAYOUT_split_3x5_2(KC_NO, KC_CIRC, KC_MINS, KC_PLUS, KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_UNDS, KC_LT, KC_COMM, KC_QUOT, KC_BSLS, KC_NO, KC_4, KC_5, KC_6, KC_NO, KC_NO, KC_GT, KC_SLSH, KC_ASTR, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_NO, KC_NO, KC_NO, KC_ENT, KC_P0),
	[3] = LAYOUT_split_3x5_2(KC_NO, KC_TILD, KC_PIPE, KC_AMPR, KC_NO, KC_NO, KC_GRV, KC_DQUO, KC_QUOT, KC_NO, KC_AT, KC_LBRC, KC_LCBR, KC_LPRN, KC_PERC, KC_DLR, KC_COLN, KC_SCLN, KC_EQL, KC_HASH, KC_NO, KC_RBRC, KC_RCBR, KC_RPRN, KC_NO, KC_NO, KC_EXLM, KC_QUES, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
	[4] = LAYOUT_split_3x5_2(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO, KC_RALT, KC_RCTL, KC_NO, KC_NO, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_RSFT, KC_RGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
