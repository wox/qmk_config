...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(G(S(KC_Z)), LGUI(KC_Z), KC_LCTL, KC_LALT, LGUI(KC_C), KC_NO, KC_PGDN, KC_UP, KC_PGUP, KC_NO, KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, LGUI(KC_V), KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_DEL, KC_BSPC, KC_SPC, KC_ENT, LGUI(KC_X), KC_NO, KC_HOME, KC_LSFT, KC_END, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
