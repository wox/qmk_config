...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(SGUI(KC_Z), KC_DEL, LCTL_T(KC_ENT), LALT_T(KC_ESC), KC_LEAD, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_NO, LGUI(KC_Z), KC_BSPC, KC_LGUI, KC_LSFT, KC_SPC, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, CW_TOGG, LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[4] = LAYOUT_split_3x5_2(KC_NO, KC_LT, KC_PMNS, KC_GT, KC_CIRC, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_AT, KC_PLUS, KC_SLSH, KC_DOT, KC_PERC, KC_NO, KC_4, KC_5, KC_6, KC_0, KC_NO, KC_UNDS, KC_ASTR, KC_COMM, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[6] = LAYOUT_split_3x5_2(QK_BOOT, KC_NO, HYPR(KC_F9), KC_NO, TO(10), KC_NO, LGUI(KC_EQL), LGUI(KC_MINS), KC_NO, KC_NO, KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, TO(11), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_MPLY, KC_MFFD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
