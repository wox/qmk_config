...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(SGUI(KC_Z), KC_DEL, LCTL_T(KC_ENT), LALT_T(KC_ESC), QK_LEAD, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_NO, LGUI(KC_Z), KC_BSPC, KC_LGUI, KC_LSFT, KC_SPC, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, CW_TOGG, LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
