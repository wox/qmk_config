...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, LSFT_T(KC_ESC), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, RALT(KC_W), RALT(KC_A), RALT(KC_O), LT(1,KC_SPC), LT(2,KC_TAB), LT(6,KC_ENT), LT(3,KC_BSPC)),
	[1] = LAYOUT_split_3x5_2(G(S(KC_Z)), LGUI(KC_Z), OSM(MOD_LCTL), OSM(MOD_LALT), LGUI(KC_C), KC_NO, KC_PGDN, KC_UP, KC_PGUP, KC_LSFT, KC_ESC, KC_TAB, OSM(MOD_LGUI), OSM(MOD_LSFT), LGUI(KC_V), KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_CAPS, KC_DEL, KC_BSPC, KC_SPC, KC_ENT, LGUI(KC_X), KC_NO, KC_HOME, KC_NO, KC_END, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[3] = LAYOUT_split_3x5_2(KC_NO, KC_CIRC, KC_MINS, KC_PLUS, KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_AT, KC_LT, KC_COMM, KC_DOT, KC_PERC, KC_0, KC_4, KC_5, KC_6, KC_UNDS, KC_NO, KC_GT, KC_SLSH, KC_ASTR, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[4] = LAYOUT_split_3x5_2(KC_NO, KC_TILD, KC_PIPE, KC_AMPR, KC_BSLS, KC_NO, KC_GRV, KC_DQUO, KC_QUOT, KC_NO, KC_NO, KC_LBRC, KC_LCBR, KC_LPRN, KC_NO, KC_DLR, KC_COLN, KC_SCLN, KC_EQL, KC_HASH, KC_NO, KC_RBRC, KC_RCBR, KC_RPRN, KC_NO, KC_NO, KC_EXLM, KC_QUES, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS),
	[5] = LAYOUT_split_3x5_2(RESET, KC_NO, HYPR(KC_F9), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_MPLY, KC_MFFD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO),
...
uint32_t layer_state_set_user(uint32_t state) {
  state = update_tri_layer_state(state, 1, 3, 4);
